...
class _RecipeDetailState extends State<RecipeDetail> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _show = AnimationController(vsync: this, duration: Duration(milliseconds: 350));
  ...
  Widget build(BuildContext context) {
    ...
    return Hero(
      ...
      flightShuttleBuilder: (
        ...
        return RotationTransition(turns: animation, child: toHero.child);
      },
      child: Image.asset(
        imagePath,
  ...
  Widget build(BuildContext context) {
    return Hero(
      ...
      flightShuttleBuilder: (
        ...
        Animation<BorderRadius> _borderAnimation = BorderRadiusTween(
